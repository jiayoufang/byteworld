...
{
    if (!_dataArray) {
        _dataArray = @[@"JYTableViewController",@"JYAlertViewController",@"JYWebViewController",@"JYLabelViewController",@"JYButtonViewController",@"JYTextViewController",@"JYImageViewController"];
    }
    return _dataArray;
}
